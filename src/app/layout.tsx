...
export const metadata: Metadata = {
  title: "MoonCoin - The Most Epic Meme Coin Revolution! 🚀",
  description: "Join the wildest meme coin adventure to the moon! MoonCoin offers insane gains, diamond hand rewards, and the most fun crypto community ever. Buy now!",
  keywords: "meme coin, cryptocurrency, MoonCoin, moon, rocket, crypto community, diamond hands, buy crypto",
  openGraph: {
    title: "MoonCoin - Epic Meme Coin Revolution! 🚀",
    description: "The wildest meme coin adventure with insane potential gains and epic community!",
    siteName: "MoonCoin",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/7527909/pexels-photo-7527909.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "MoonCoin rocket to the moon"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "MoonCoin - To The Moon! 🚀",
    description: "Join the most epic meme coin revolution with diamond hand rewards!",
    images: ["https://images.pexels.com/photos/7527909/pexels-photo-7527909.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
